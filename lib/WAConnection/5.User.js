...
class WAConnection extends _4_Events_1.WAConnection {
    constructor() {
        ...
        this.isOnWhatsApp = (jid) => this.query({ json: ['query', 'exist', jid], requiresPhoneConnection: false }).then((m) => m.status === 200);
        /**
    ...
    async loadChats(count, before, options = {}) {
        ...
        const chats = this.chats.paginated(before, count, options && (chat => {
            ...
            return ((typeof (options === null || options === void 0 ? void 0 : options.custom) !== 'function' || (options === null || options === void 0 ? void 0 : options.custom(chat))) &&
                (typeof searchString === 'undefined' || ((_a = chat.name) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(searchString)) || ((_b = chat.jid) === null || _b === void 0 ? void 0 : _b.startsWith(searchString))));
        }));
