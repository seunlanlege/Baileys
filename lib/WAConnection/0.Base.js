...
class WAConnection extends events_1.EventEmitter {
    constructor() {
        ...
        this.rejectPendingConnection = (e) => { };
        /**
    ...
    startDebouncedTimeout() {
        this.stopDebouncedTimeout();
        this.debounceTimeout = setTimeout(() => this.rejectPendingConnection(Constants_1.TimedOutError()), this.connectOptions.maxIdleTimeMs);
    }
